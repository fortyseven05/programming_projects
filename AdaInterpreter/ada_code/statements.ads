...
package statements is
   ...
   procedure add_statement (this: in out block; stmt: in statement_access);
   
   procedure execute (this: in block);
   
   function make (expr: in arithmetic_expression_access) return statement_access;
   ...
   function make (lvalue: in id; expr: in arithmetic_expression_access) return statement_access;
